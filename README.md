...
MetricScoreTop-1 Accuracy~27–33%Top-5 Accuracy~65%Yes/No Accuracy~50%Number Accuracy~22%Other Accuracy~7%
...
Input Image + Question → Attention Heatmap Overlay → result.png
 ...
 Tech Stack
ComponentToolDeep LearningPyTorchVision EncoderCLIP (OpenAI, via HuggingFace)Text EncoderDistilBERT (HuggingFace Transformers)Attention VisualizationOpenCVData & PlottingNumPy, Matplotlib

 Usage
Training
bashpython run_train.py
...
[konabharath2004@gmail.com] | [https://www.linkedin.com/in/kona-bharath-vamshidhar-reddy/] | [https://github.com/Stevemeg/]
