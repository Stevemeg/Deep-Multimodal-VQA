...
TRAIN_Q_PATH = r"C:\Users\konab\OneDrive\Desktop\Career\projects\VQA_Project\data\vqa\v2_OpenEnded_mscoco_train2014_questions.json"
...
def main():
    ...
    print(f"Unique images in train subset: {len(image_ids)}")

    vision = CLIPVisionEncoder(device="cpu")

    save_split_path = os.path.join(SAVE_ROOT, "train2014_subset")
